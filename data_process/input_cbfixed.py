...
def read_data_sets():
    ...
    train_label8 = np.load('../DATA_CB513/train_label8.npy').reshape((-1, 700, 8))
    ...
    test_label8 = np.load('../DATA_CB513/test_label8.npy').reshape((-1, 700, 8))
    ...
    data_sets.train = DataSet(train_sequence_feature, train_label8)
    data_sets.test = DataSet(test_sequence_feature, test_label8)

...
weights = {
    ...
    'out': tf.Variable(tf.truncated_normal([2 * n_hidden, 8]))
...
with tf.Session() as sess:
    ...
    batch_xs, batch_ys, sequence_len, mask_wei = cb513.test.next_batch(514)
